...
\hspace{-0.5cm}Quatre notions triviales en cryptologie, qui seront reprises de nombreuses fois au travers de ce travail, doivent également être définies : 
\begin{description}
...
\hspace{-0.5cm}La figure \ref{} illustre ces quatre notions fondamentales en cryptographie.

\newpage
\hspace{-0.5cm}Revenons sur la notion de cryptographie. La cryptographie doit remplir trois conditions majeures :
\begin{itemize}
\item Confidentialité : La confidentialité spécifie que seules les personnes autorisées à accéder à une certaine information ont la possibilité de l'atteindre.
\item Intégrité : L'intégrité spécifie que l'information, lors de son traitement ou de sa transmission, ne subit aucun modification volontaire ou accidentelle. Autrement dit, il s'agit d'une garantie que l'information conserve son état d'origine.
\item Disponibilité : La disponibilité spécifie que l'information est en tout temps disponible pour une personne autorisée à y accéder et en demandant l'accès. \\
\end{itemize}
