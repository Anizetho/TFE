...
\begin{figure}[htbp]
    \centering
    \includegraphics[scale=0.5]{image/SubBytes}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[scale=0.7]{image/ligne}
